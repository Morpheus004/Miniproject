...
function ProfilePage() {
  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', minHeight: "100vh", backgroundImage: `url(${backgroundImage})`, backgroundSize: "cover" }}>
      <div style={{ margin: 'auto', maxWidth: '800px', padding: '110px' }}>
        <div style={{ display: 'flex', flexDirection: 'row' }}>
          <div style={{ flex: '1', marginRight: '20px', backgroundColor: 'white', borderRadius: '5px', padding: '20px', border: '1px solid #ddd' }}>
